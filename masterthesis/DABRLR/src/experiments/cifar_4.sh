...
python federated.py --data=cifar100 --local_ep=2 --bs=256 --num_agents=10 --rounds=10 --num_corrupt=1 --poison_frac=0.5 --climg_attack=0 --pattern=square --delta_val=0 --delta_attack=0 --attack=optimize --explain=3
python federated.py --data=tinyimage --local_ep=2 --bs=256 --num_agents=10 --rounds=10 --num_corrupt=1 --poison_frac=0.5 --climg_attack=0 --pattern=square --delta_val=0 --delta_attack=0 --attack=optimize --explain=3
