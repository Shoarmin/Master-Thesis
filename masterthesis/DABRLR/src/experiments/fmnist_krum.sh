...
srun python federated.py --data=fmnist --local_ep=2 --bs=256 --num_agents=10 --rounds=100 --num_corrupt=1 --poison_frac=0.5 --pattern=sig --delta_val=20 --delta_attack=30 --aggr=krum --distribution=dirichlet --alpha=0.8
srun python federated.py --data=fmnist --local_ep=2 --bs=256 --num_agents=10 --rounds=100 --num_corrupt=1 --poison_frac=0.5 --pattern=sig --delta_val=20 --delta_attack=20 --aggr=krum --distribution=dirichlet --alpha=0.8
