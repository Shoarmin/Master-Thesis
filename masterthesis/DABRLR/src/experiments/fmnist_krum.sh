...
srun python federated.py --data=fmnist --local_ep=2 --bs=256 --num_agents=10 --rounds=100 --num_corrupt=1 --poison_frac=0.5 --pattern=sig --delta_val=40 --delta_attack=40 --aggr=krum 
srun python federated.py --data=fmnist --local_ep=2 --bs=256 --num_agents=10 --rounds=100 --num_corrupt=1 --poison_frac=0.5 --pattern=sig --delta_val=40 --delta_attack=30 --aggr=krum 
srun python federated.py --data=fmnist --local_ep=2 --bs=256 --num_agents=10 --rounds=100 --num_corrupt=1 --poison_frac=0.5 --pattern=sig --delta_val=40 --delta_attack=25 --aggr=krum 
srun python federated.py --data=fmnist --local_ep=2 --bs=256 --num_agents=10 --rounds=100 --num_corrupt=1 --poison_frac=0.5 --pattern=sig --delta_val=40 --delta_attack=20 --aggr=krum 
