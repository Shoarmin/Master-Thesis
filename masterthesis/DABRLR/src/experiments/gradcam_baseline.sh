...
# srun python federated.py --data=cifar10 --local_ep=2 --bs=256 --num_agents=10 --rounds=100 --num_corrupt=0 --poison_frac=0.5 --climg_attack=0 --pattern=sig --delta_val=0 --delta_attack=0 --explain=1 --target_class=5
srun python federated.py --data=cifar10 --local_ep=2 --bs=256 --num_agents=10 --rounds=100 --num_corrupt=1 --poison_frac=0.5 --climg_attack=0 --pattern=square --delta_val=0 --delta_attack=0 --explain=1
